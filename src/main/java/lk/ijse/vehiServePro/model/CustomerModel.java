...
/*
   *//* public boolean saveCustomer(final CustomerDTO dto) throws SQLException {
       /* Connection connection = DbConnection.getInstance().getConnection();
        ...
        boolean isSaved = customerDAO.save(new Customer(dto.getId(),dto.getName(),dto.getAddress(),dto.getEmail(),dto.getContact()));
        return isSaved;
    }
    ...
    public boolean updateCustomer( CustomerDTO dto) throws SQLException {
       *//* Connection connection = DbConnection.getInstance().getConnection();
        ...
        CustomerDAOImpl customerDAO = new CustomerDAOImpl();
        boolean isUpdated = customerDAO.update(new Customer(dto.getId(),dto.getName(),dto.getAddress(),dto.getEmail(),dto.getContact()));
        return isUpdated;
    }
    ...
    public List<CustomerDTO> getAllCustomers() throws SQLException {
       *//* Connection connection = DbConnection.getInstance().getConnection();
        ...
        ArrayList<Customer> allCustomer = (ArrayList<Customer>) customerDAO.getAll();
